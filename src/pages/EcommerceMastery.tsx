...
const EcommerceMastery: React.FC = () => {
  ...
  const course = {
    ...
    heroPhoto: 'https://i.ibb.co/3mf75C6R/2.webp',
    price: 170,
  ...
  return (
    ...
    >
      ...
      {/* Header with larger course title */}
      <div className="bg-white py-4 mb-2 border-b">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900">{course.name}</h1>
          </div>
        </div>
      </div>
      
      {/* Course info and video section - reduced top margin */}
      <div className="container mx-auto px-4 pt-0 pb-4"> 
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          {/* Course card with details - fixed sidebar alignment */}
          <div className="md:col-span-4 lg:col-span-3">
            <div className="bg-green-50 rounded-xl overflow-hidden shadow-lg sticky top-24">
              ...
              {/* Price and CTA Button in sidebar - showing correct price */}
          ...
          <div className="md:col-span-8 lg:col-span-9">
            ...
            <div className="mb-8">
              {!isVideoPlaying ? (
                ...
                <div className="relative rounded-lg overflow-hidden shadow-lg" style={{ height: '500px' }}>
                  <iframe 
                    src={`${course.videoUrl}?autoplay=1&start=1`}
            ...
            {/* Course description - Arabic typography fixes */}
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold mb-4 text-right" dir="rtl">{course.description}</h2>
              <p className="text-gray-700 text-right leading-relaxed" dir="rtl">{course.longDescription}</p>
            </div>
            
            {/* Course modules - improved spacing and organization */}
      ...
      {/* Meet Your Instructor - Fixed centering of image */}
      ...
      {/* Final CTA section - Fixed with correct price and better spacing */}
