...
import noodLogo from '/src/assets/nood.svg'; // Make sure to import the Nood logo SVG
...
const MeetHeroCard: React.FC<MeetHeroCardProps> = ({ name, title, image, linkedin, instagram, course }) => {
  return (
    <StyledWrapper>
      <div className="card">
        <img src={noodLogo} alt="Nood Logo" className="nood-logo" />
